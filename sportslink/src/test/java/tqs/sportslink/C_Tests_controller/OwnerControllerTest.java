...
class OwnerControllerTest {
        ...
        void createFacility_WithImage_ShouldReturn200() throws Exception {
                ...
                when(ownerService.createFacility(eq(ownerId), any(FacilityRequestDTO.class), any()))
        ...
        void getOwnerFacilities_ShouldReturnList() throws Exception {
                ...
                mockMvc.perform(org.springframework.test.web.servlet.request.MockMvcRequestBuilders
                                .get("/api/owner/{ownerId}/facilities", ownerId))
                                .andExpect(status().isOk())
        ...
        void updateFacility_ShouldReturnUpdated() throws Exception {
                ...
                mockMvc.perform(org.springframework.test.web.servlet.request.MockMvcRequestBuilders
                                .put("/api/owner/{ownerId}/facilities/{facilityId}", ownerId, facilityId)
        ...
        void addEquipment_ShouldReturnCreated() throws Exception {
                ...
                mockMvc.perform(org.springframework.test.web.servlet.request.MockMvcRequestBuilders
                                .post("/api/owner/{ownerId}/facilities/{facilityId}/equipment", ownerId, facilityId)
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(objectMapper.writeValueAsString(request)))
                                .andExpect(status().isOk())
