...
class RentalIntegrationTest {
        ...
        /**
         * Teste do fluxo completo: buscar -> consultar equipamentos -> criar rental ->
         * atualizar -> cancelar
         */
        @Test
        void whenCompleteRentalFlow_thenSuccess() {
                ...
                request.setEndTime(
                                LocalDateTime.now().plusDays(2).withHour(21).withMinute(0).withSecond(0).withNano(0));
        ...
        void whenCreateConflictingRental_thenStatus400() {
                LocalDateTime start = LocalDateTime.now().plusDays(2).withHour(14).withMinute(0).withSecond(0)
                                .withNano(0);
                LocalDateTime end = LocalDateTime.now().plusDays(2).withHour(16).withMinute(0).withSecond(0)
                                .withNano(0);
        ...
        @Test
        @Requirement("SL-30")
        void whenCancelRental_thenStatusIsCancelled() {
                given()
                                .when()
        ...
        @Test
        @Requirement("SL-29")
        void whenCreateRentalWithConflict_thenThrowException() {
                // Criar primeiro rental 14:00-16:00
                RentalRequestDTO request1 = new RentalRequestDTO();
                request1.setUserId(testUser.getId());
                request1.setFacilityId(testFacility.getId());
                request1.setStartTime(
                                LocalDateTime.now().plusDays(20).withHour(14).withMinute(0).withSecond(0).withNano(0));
                request1.setEndTime(
                                LocalDateTime.now().plusDays(20).withHour(16).withMinute(0).withSecond(0).withNano(0));
                ...
                request2.setUserId(testUser.getId());
                request2.setFacilityId(testFacility.getId());
                request2.setStartTime(
                                LocalDateTime.now().plusDays(20).withHour(17).withMinute(0).withSecond(0).withNano(0));
                request2.setEndTime(
                                LocalDateTime.now().plusDays(20).withHour(19).withMinute(0).withSecond(0).withNano(0));
                ...
                updateRequest.setFacilityId(testFacility.getId());
                updateRequest
                                .setStartTime(LocalDateTime.now().plusDays(20).withHour(17).withMinute(0).withSecond(0)
                                                .withNano(0));
                updateRequest.setEndTime(
                                LocalDateTime.now().plusDays(20).withHour(19).withMinute(0).withSecond(0).withNano(0));
