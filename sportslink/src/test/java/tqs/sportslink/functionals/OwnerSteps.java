...
public class OwnerSteps {
    ...
    public void i_am_logged_in_as_owner() {
        ...
        // Login as owner using DataInitializer credentials
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("loginForm")));
        driver.findElement(By.id("email")).sendKeys("owner@sportslink.com");
    ...
    public void i_am_on_owner_dashboard() {
        ...
        // Also wait for the Add Facility button to be clickable (ensures JS initialization is complete)
    ...
    public void verify_facility_in_list(String nameFragment) {
        ...
        // Since we used unique name, we can filter for part of it or just check if any card contains it
        // Note: The UI might need refresh or auto-updates. owner_dashboard.js usually re-fetches.
    ...
    public void verify_suggestions_list() {
        ...
        // Better to be robust: check for "body" usage or wait for specific element if I knew it.
